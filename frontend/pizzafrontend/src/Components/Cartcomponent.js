...
function Cartcomponent() {
    ...
    const Orderconfirm=(e)=>{
        ...
        console.log(user[0])
        const datasend={id:user[0]._id,date:Date().toLocaleString(undefined, {timeZone: 'Asia/Kolkata'}),order:data,email:user[0].email}
    ...
    return (
        <div style={{backgroundImage:"url('../Images/background1.jpg')",backgroundRepeat:"no-repeat",backgroundSize:"cover",backgroundPosition:"center",height:"560px",color:"white",paddingLeft:"40px",paddingRight:"40px"}}>
            <h1>Cart</h1>
            <Table striped bordered hover style={{backgroundImage:"url('../Images/cartbackground.jpg')",backgroundRepeat:"no-repeat",backgroundSize:"cover",backgroundPosition:"center"}} className="changefont">
        <thead>
          <tr>
            <th >#</th>
            <th >Name</th>
        ...
        <tbody>
          ...
          <Row>
              <Col>
            <p className="changefont" style={{color:"white"}}>Total: {totalbalance} RS</p></Col><Col><button type="button" className="btn btn-primary changefont" onClick={Orderconfirm} style={{color:"white"}} >Order</button></Col></Row>
        </div>
    )
}
