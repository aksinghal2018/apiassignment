...
function Login() {
    ...
    return (
        <div style={{paddingLeft:"20px",paddingTop:"25px",paddingBottom:"150px" ,backgroundImage:"url('../Images/background1.jpg')",backgroundRepeat:"no-repeat",backgroundSize:"cover",backgroundPosition:"center"}}>
